module weno_rhombus_mod
  ...
  integer, target :: stencil_5(4,13) = [ &
    ...
    [3,4,3,0], [4,3,0,3], [2,4,1,2], [4,2,2,1], & ! x^3, y^3, x * y^2, x^2 * y
    [5,3,4,0], [3,5,0,4], [4,4,2,2]             & ! x^4, y^4, x^2 * y^2
  ]
  !                               1 2 3
  integer, target :: substencil_5(4,5,9) = [ &
    [[3,3,0,0], [2,3,1,0], [3,2,0,1], [1,3,2,0], [2,2,1,1]], &
    [[3,3,0,0], [2,3,1,0], [3,2,0,1], [3,1,0,2], [2,2,1,1]], &
    [[3,3,0,0], [4,3,1,0], [3,2,0,1], [3,1,0,2], [4,2,1,1]], &
    [[3,3,0,0], [4,3,1,0], [3,2,0,1], [5,3,2,0], [4,2,1,1]], &
    [[3,3,0,0], [4,3,1,0], [3,4,0,1], [5,3,2,0], [4,4,1,1]], &
    [[3,3,0,0], [4,3,1,0], [3,4,0,1], [3,5,0,2], [4,4,1,1]], &
    [[3,3,0,0], [2,3,1,0], [3,4,0,1], [3,5,0,2], [2,4,1,1]], &
    [[3,3,0,0], [2,3,1,0], [3,4,0,1], [1,3,2,0], [2,4,1,1]], &
    [[3,3,0,0], [2,3,1,0], [3,4,0,1], [4,3,2,0], [3,2,0,2]]  &
  ]
