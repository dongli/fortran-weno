module weno_rhombus_mod
  ...
  integer, target :: stencil_5(4,13) = [ &
    [3,3,0,0],                                  & ! 1
    [2,3,1,0], [3,2,0,1],                       & ! x, y
    [1,3,2,0], [3,1,0,2], [2,2,1,1],            & ! x^2, y^2, x * y
    [4,3,3,0], [3,4,0,3], [2,4,1,2], [4,2,2,1], & ! x^3, y^3, x * y^2, x^2 * y
    [5,3,4,0], [3,5,0,4], [4,4,2,2]             & ! x^4, y^4, x^2 * y^2
  ]
  !                               1 2 3
  integer, target :: substencil_5(4,5,9) = [ &
    [[3,3,0,0], [2,3,1,0], [3,2,0,1], [1,3,2,0], [2,2,1,1]], & ! sub-stencil 1
    [[3,3,0,0], [2,3,1,0], [3,2,0,1], [3,1,0,2], [2,2,1,1]], & ! sub-stencil 2
    [[3,3,0,0], [4,3,1,0], [3,2,0,1], [3,1,0,2], [4,2,1,1]], & ! sub-stencil 3
    [[3,3,0,0], [4,3,1,0], [3,2,0,1], [5,3,2,0], [4,2,1,1]], & ! sub-stencil 4
    [[3,3,0,0], [4,3,1,0], [3,4,0,1], [5,3,2,0], [4,4,1,1]], & ! sub-stencil 5
    [[3,3,0,0], [4,3,1,0], [3,4,0,1], [3,5,0,2], [4,4,1,1]], & ! sub-stencil 6
    [[3,3,0,0], [2,3,1,0], [3,4,0,1], [3,5,0,2], [2,4,1,1]], & ! sub-stencil 7
    [[3,3,0,0], [2,3,1,0], [3,4,0,1], [1,3,2,0], [2,4,1,1]], & ! sub-stencil 8
    [[3,3,0,0], [2,3,1,0], [3,4,0,1], [4,3,2,0], [3,2,0,2]]  & ! sub-stencil 9
  ]
  !integer, target :: substencil_5(4,5,8) = [ &
  !  [[3,3,0,0], [2,3,1,0], [3,2,0,1], [1,3,2,0], [2,2,1,1]], & ! sub-stencil 1
  !  [[3,3,0,0], [2,3,1,0], [3,2,0,1], [3,1,0,2], [2,2,1,1]], & ! sub-stencil 2
  !  [[3,3,0,0], [4,3,1,0], [3,2,0,1], [3,1,0,2], [4,2,1,1]], & ! sub-stencil 3
  !  [[3,3,0,0], [4,3,1,0], [3,2,0,1], [5,3,2,0], [4,2,1,1]], & ! sub-stencil 4
  ...
  !  [[3,3,0,0], [2,3,1,0], [3,4,0,1], [1,3,2,0], [2,4,1,1]]  & ! sub-stencil 8
  !]
  !integer, target :: substencil_5(4,6,8) = [ &
  !  [[3,3,0,0], [2,3,1,0], [3,2,0,1], [1,3,2,0], [3,1,0,2], [2,2,1,1]], &
  !  [[3,3,0,0], [4,3,1,0], [3,2,0,1], [5,3,2,0], [3,1,0,2], [4,2,1,1]], &
  !  [[3,3,0,0], [4,3,1,0], [3,4,0,1], [5,3,2,0], [3,5,0,2], [4,4,1,1]], &
  !  [[3,3,0,0], [2,3,1,0], [3,4,0,1], [1,3,2,0], [3,5,0,2], [2,4,1,1]], &
  !  [[3,3,0,0], [2,3,1,0], [3,2,0,1], [2,2,1,1], [3,4,0,2], [2,4,1,2]], &
  !  [[3,3,0,0], [2,3,1,0], [3,2,0,1], [2,2,1,1], [4,3,2,0], [4,2,2,1]], &
  !  [[3,3,0,0], [4,3,1,0], [3,2,0,1], [4,2,1,1], [3,4,0,2], [4,4,1,2]], &
  !  [[3,3,0,0], [4,3,1,0], [3,4,0,1], [4,4,1,1], [2,3,2,0], [2,4,2,1]]  &
  !]
  !integer, target :: substencil_5(4,6,4) = [ &
  !  [[3,3,0,0], [2,3,1,0], [3,2,0,1], [1,3,2,0], [3,1,0,2], [2,2,1,1]], &
  !  [[3,3,0,0], [4,3,1,0], [3,2,0,1], [5,3,2,0], [3,1,0,2], [4,2,1,1]], &
  !  [[3,3,0,0], [4,3,1,0], [3,4,0,1], [5,3,2,0], [3,5,0,2], [4,4,1,1]], &
  !  [[3,3,0,0], [2,3,1,0], [3,4,0,1], [1,3,2,0], [3,5,0,2], [2,4,1,1]]  &
...
contains
  ...
  subroutine weno_rhombus_init(this, sw, swx, swy, xc, yc, is, ie, js, je, id)
  ...
  subroutine weno_rhombus_add_point(this, x, y)
